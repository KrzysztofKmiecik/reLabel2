...
//FD20111602641T28738159;FD20111992641T28742559
        String input2DCode="FZ201130X2320T28744310";
        ...
        zebra.open();
        String acknoladge = zebra.replaceInZpl(prepareStringToPrint);
...
//FD20111602641T28738159;FD20111992641T28742559
        ...
        Zebra zebra = new Zebra(zpl, rs232);
        zebra.open();
        String acknoladge = zebra.replaceInZpl(input2DCode);
        System.out.println(acknoladge);
     /*   String printerIsReady = zebra.sendAndReceivedCommand("~HS");
        if (printerIsReady.equals("")) {
            System.out.println("printer is ready");
    ...
    @Test
    void validateComPort(){
      //  Zebra.validateComParam("COM2")
    }
